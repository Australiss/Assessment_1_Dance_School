...
public class StudentRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, AppBase.classes);
    ...
    public void saveToDatabase(View view) {
        ...
        EditText parentsName = (EditText) findViewById(R.id.edit_parentsName);
        ...
        String qu = "INSERT INTO STUDENT VALUES('" + name.getText().toString() + "','" + parentsName.getText().toString() + "'," +
                "'" + classSelected + "'," +
        ...
        Log.d("Student Reg", qu);
        if (Login.handler.execQuery(qu) != null) {
