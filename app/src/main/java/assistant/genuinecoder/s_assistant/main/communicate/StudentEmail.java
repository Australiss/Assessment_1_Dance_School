...
public class StudentEmail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnx = (Button) findViewById(R.id.buttonSendEmail);
        assert btnx != null;
        btnx.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                adapter.getEmails();
                ArrayList<String> EmailsArrayList = new ArrayList<String>(ListAdapter.emails);
                String[] addresses = EmailsArrayList.toArray(new String[0]);
