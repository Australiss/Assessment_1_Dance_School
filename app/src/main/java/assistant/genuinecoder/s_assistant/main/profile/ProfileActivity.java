...
public class ProfileActivity extends AppCompatActivity {
    ...
    DatabaseHandler handler = Login.handler;
                ...
                alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (Login.handler.execAction(qu)) {
                            ...
                            if (Login.handler.execAction(qa)) {
    ...
    public void find(View view) {
        ...
        if (cursor == null || cursor.getCount() == 0) {
            ...
            buffer += "Parents name:"+ " " + cursor.getString(1) + "\n";
            buffer += "Class:"+ " " + cursor.getString(2) + "\n";
            buffer += "Admission No:" + " " + cursor.getString(3) + "\n";
            buffer += "Contact No:" + " " + cursor.getString(4) + "\n";
            buffer += "Email:" + " " + cursor.getString(6) + "\n";
            buffer += attendance + "\n";
